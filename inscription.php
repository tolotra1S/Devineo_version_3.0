<?php
    ...
    if(isset($_POST['envoi'])){
        if(!empty($_POST['pseudo']) AND !empty($_POST['mdp'])){
            ...
            $mdp = sha1($_POST['mdp']);
            $mail = ($_POST['mail']);
            $insertUsers= $bdd->prepare('INSERT INTO users(pseudo,mdp,mail) VALUES(?,?,?)');
            $insertUsers->execute(array($pseudo,$mdp,$mail));

            $recup_user= $bdd->prepare("SELECT * FROM users WHERE pseudo = ? AND mdp= ? AND mail= ? ");
            $recup_user->execute(array($pseudo,$mdp,$mail));
            ...
            <div class="container1">
                ...
                <div class="fields">
                    ...
                    <div class="email">
                        ...
                        <input type="Email" class="put1" value="" name="mail"></div>
                    ...
                    <div class="but"><input type="submit" class="button" name="envoi"></input></div> 
                ...
                <div class="membre"><h5>Already membre ?<a href="connexion.php">Sign in</a></h5></div>
                </form>
            </div>
